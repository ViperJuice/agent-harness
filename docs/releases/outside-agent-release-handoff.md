...
- Version: `0.6.2`
- Runtime `phase_loop_runtime.__version__`: `0.6.2`
- Version pin prepared for downstream pinning: `phase-loop-runtime==0.6.2`
- Console scripts: `phase-loop`, `codex-phase-loop`

## Validator Identity

- Governed-pipeline validator authority: `governed_pipeline_validator`
- Validator version: `0.6.2`
...
- Wheel artifact: `phase_loop_runtime-0.6.2-py3-none-any.whl`
- Sdist artifact: `phase_loop_runtime-0.6.2.tar.gz`
- Wheel top-level entries: `phase_loop_runtime`, `phase_loop_runtime-0.6.2.data`, `phase_loop_runtime-0.6.2.dist-info`
...
`phase-loop-runtime==0.6.2`, then call:
