...
- Version: `0.7.9`
- Runtime `phase_loop_runtime.__version__`: `0.7.9`
- Version pin prepared for downstream pinning: `phase-loop-runtime==0.7.9`
- Console scripts: `phase-loop`, `codex-phase-loop`

## Validator Identity

- Governed-pipeline validator authority: `governed_pipeline_validator`
- Validator version: `0.7.9`
...
- Wheel artifact: `phase_loop_runtime-0.7.9-py3-none-any.whl`
- Sdist artifact: `phase_loop_runtime-0.7.9.tar.gz`
- Wheel top-level entries: `phase_loop_runtime`, `phase_loop_runtime-0.7.9.data`, `phase_loop_runtime-0.7.9.dist-info`
...
`phase-loop-runtime==0.7.9`, then call:
