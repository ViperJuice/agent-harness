...
Add a machine-readable automation handoff that agrees with the human-readable next step fields. For successful roadmap creation or extension with a ready phase to plan, set:

```yaml
automation:
  status: unplanned
  next_skill: <harness>-plan-phase
  next_command: <harness>-plan-phase <artifact> <next_alias>
  ...
  artifact: <absolute roadmap artifact path>
