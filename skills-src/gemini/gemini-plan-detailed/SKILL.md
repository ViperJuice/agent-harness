...
- Reflection: `resolve_skill_bundle_root("codex")/gemini-plan-detailed/reflections/<repo_hash>/<branch_slug>/<run_id>.md`
- Handoff: `<repo>/.dev-skills/handoffs/gemini-plan-detailed/<run_id>.md`
- Latest handoff pointer: `<repo>/.dev-skills/handoffs/gemini-plan-detailed/latest.md`
