...
def test_trust_executor_evidence_flag_unset_is_disabled(monkeypatch):
...
def test_trust_executor_evidence_flag_non_canonical_values_are_disabled(monkeypatch):
